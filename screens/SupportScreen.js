    ...
    <View style={{backgroundColor: 'grey'}}>
      ...
      <View style={{flexDirection: 'row', marginTop: 15, marginBottom: 20}}>
        <Image
          ...
          source={{
            uri:
              'https://scontent-cgk1-1.cdninstagram.com/v/t51.2885-15/sh0.08/e35/p640x640/72480005_524343174784290_8100841044144773174_n.jpg?_nc_ht=scontent-cgk1-1.cdninstagram.com&_nc_cat=106&_nc_ohc=01DUJRJX62UAX9lpRP5&edm=AP_V10EBAAAA&ccb=7-4&oh=5958936f481a55f09561619ea921fc34&oe=611A04B8&_nc_sid=4f375e',
          }}
        />
